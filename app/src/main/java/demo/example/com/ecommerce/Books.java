...
public class Books extends Fragment {
    ...
    String price = "price";
    String image = "image";
    String url = "http://yagnik.890m.com/webservices/fetchimageBooks.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gridBooks = (GridView) view.findViewById(R.id.gridBooks);
    ...
    public class GetBooksdata  extends AsyncTask<Void, Void, Void>{
        @Override
